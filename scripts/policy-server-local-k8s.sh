...
CMD="${1:-up}"
NS="${POLICY_SERVER_LOCAL_NAMESPACE:-scopeball}"
RELEASE="${POLICY_SERVER_LOCAL_RELEASE:-scopeball}"
IMAGE_REPOSITORY="${POLICY_SERVER_LOCAL_IMAGE_REPOSITORY:-pasu-policy-server}"
