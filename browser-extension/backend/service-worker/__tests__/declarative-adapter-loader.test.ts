/**
 * Phase M3 — declarative-adapter-loader v3 cases.
 *
 * Plan §B4 (2026-05-28) — v1 mount path (`mountDeclarativeBundle` +
 * `ensureSeedBundlesInstalled`) removed; the v1 tests in this file
 * (mountDeclarativeBundle / ensureSeedBundlesInstalled describe blocks)
 * were retired alongside the source.
 */
