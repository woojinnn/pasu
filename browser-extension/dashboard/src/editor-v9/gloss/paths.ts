...
const BASE_GLOSS_ENTRIES: readonly GlossEntry[] = [
  ...
  { path: "context.venue", ko: "거래 장소 (거래소·풀)", en: "Venue",
    role: "ref", fieldKind: "ref",
    desc: { ko: "어느 거래소·풀에서 거래하는지 (Uniswap, Curve 등)", en: "Which DEX/pool the trade happens on" } },
  { path: "context.venue.name", ko: "거래 장소 이름", en: "Venue name",
    role: "ref", fieldKind: "primitive.String",
    desc: { ko: "거래소·풀 이름 (Hyperliquid 정책은 \"hyperliquid\"로 매칭)", en: "Venue id string (HL policies match \"hyperliquid\")" } },
  ...
  { path: "context.market", ko: "선물 시장", en: "Market",
    role: "ref", fieldKind: "ref",
    desc: { ko: "어떤 선물 시장인지 (예: BTC-PERP)", en: "Perp market identifier" } },
  ...
  { path: "context.amountUsd", ko: "수량 (USD 환산)", en: "Amount (USD)",
    ...
    unit: { ko: "USD", en: "USD" } },
  { path: "context.slippageBp", ko: "가격 미끄러짐 허용치", en: "Slippage",
    role: "numeric", fieldKind: "primitive.Long",
    desc: { ko: "체결가가 예상가에서 벗어나도 허용하는 한도 (100 = 1%)", en: "Max slippage allowed (100bp = 1%)" },
    unit: { ko: "bp", en: "bp" } },
  { path: "context.priceImpactBp", ko: "내 거래의 시세 영향", en: "Price impact",
    role: "numeric", fieldKind: "primitive.Long",
    desc: { ko: "이 거래가 시장 가격을 얼마나 움직이는지 (100 = 1%)", en: "Price-impact of this tx (100bp = 1%)" },
    unit: { ko: "bp", en: "bp" } },
  ...
  { path: "context.markPrice", ko: "청산 기준 가격", en: "Mark price",
    role: "numeric", fieldKind: "primitive.String",
    desc: { ko: "선물의 청산을 판단하는 기준 가격(마크 가격)", en: "Mark price (perp liquidation reference)" } },
  ...
  // ── Perp::PlaceOrder — unified order placement (limit / stop / twap). The
  //    order kind + its per-kind fields live under `orderType.*`; gloss them so
  //    "언제 위험한가요" can gate on order type / trigger price / TWAP, etc.
  { path: "context.orderType.kind", ko: "주문 유형", en: "Order type",
    role: "enum", fieldKind: "primitive.String",
    desc: { ko: "지정가 / 스탑 / TWAP 중 무엇인지: \"limit\" | \"stop\" | \"twap\". 예: TWAP 차단", en: "limit | stop | twap" } },
  { path: "context.orderType.price", ko: "주문 지정가", en: "Order price",
    role: "numeric", fieldKind: "primitive.String",
    desc: { ko: "지정가 주문의 가격 (limit)", en: "Limit order price" } },
  { path: "context.orderType.timeInForce.kind", ko: "주문 유효기간", en: "Time in force",
    role: "enum", fieldKind: "primitive.String",
    desc: { ko: "주문 체결 정책: \"gtc\" | \"ioc\" | \"fok\" | \"post_only\" | \"gtd\"", en: "gtc | ioc | fok | post_only | gtd" } },
  { path: "context.orderType.triggerPrice", ko: "발동 가격", en: "Trigger price",
    role: "numeric", fieldKind: "primitive.String",
    desc: { ko: "스탑 주문이 발동되는 가격 (stop)", en: "Price that triggers a stop order" } },
  { path: "context.orderType.orderKind", ko: "스탑 주문 종류", en: "Stop order kind",
    role: "enum", fieldKind: "primitive.String",
    desc: { ko: "\"stop_market\" | \"stop_limit\" | \"take_profit\" | \"take_profit_limit\"", en: "stop_market | stop_limit | take_profit | take_profit_limit" } },
  { path: "context.orderType.limitPrice", ko: "스탑 지정가", en: "Stop limit price",
    role: "numeric", fieldKind: "primitive.String",
    desc: { ko: "stop_limit / take_profit_limit 의 지정가", en: "Limit price for stop_limit / take_profit_limit" } },
  { path: "context.orderType.durationMinutes", ko: "TWAP 시간", en: "TWAP duration",
    role: "numeric", fieldKind: "primitive.Long",
    desc: { ko: "TWAP 주문을 나눠 체결할 시간 (분)", en: "TWAP execution window in minutes" },
    unit: { ko: "분", en: "min" } },
  { path: "context.orderType.randomize", ko: "TWAP 무작위화", en: "TWAP randomize",
    role: "enum", fieldKind: "primitive.Bool",
    desc: { ko: "TWAP 분할을 무작위화하는지", en: "Whether TWAP slices are randomized" } },
  { path: "context.bestBid", ko: "최우선 매수호가", en: "Best bid",
    role: "numeric", fieldKind: "primitive.String",
    desc: { ko: "주문 시점 호가창의 최우선 매수 가격", en: "Best bid on the book at order time" } },
  { path: "context.bestAsk", ko: "최우선 매도호가", en: "Best ask",
    role: "numeric", fieldKind: "primitive.String",
    desc: { ko: "주문 시점 호가창의 최우선 매도 가격", en: "Best ask on the book at order time" } },
  { path: "context.openOrdersCount", ko: "미체결 주문 수", en: "Open orders count",
    role: "numeric", fieldKind: "primitive.Long",
    desc: { ko: "이 시장에 현재 열려 있는 내 미체결 주문 수", en: "My open orders on this market" },
    unit: { ko: "개", en: "" } },
  { path: "context.size.amountDecimal", ko: "주문 수량 (소수)", en: "Order amount (decimal)",
    role: "numeric", fieldKind: "primitive.String",
    desc: { ko: "기초자산 단위의 주문 수량 (소수, HL)", en: "Order size in base-asset units (decimal; HL)" } },
  { path: "context.newLeverage", ko: "새 레버리지", en: "New leverage",
    role: "numeric", fieldKind: "primitive.decimal",
    desc: { ko: "레버리지 변경 후 적용될 배율 (상한 정책에 사용)", en: "Resulting leverage after the change" },
    unit: { ko: "x", en: "x" } },
  ...
  { path: "context.enrichment.totalInputUsd", ko: "입력 가치 (USD)", en: "Input value (USD)",
    ...
    unit: { ko: "USD", en: "USD" } },
  { path: "context.enrichment.effectiveRateVsOracleBps", ko: "기준 시세 대비 체결가 차이", en: "Slippage vs oracle",
    role: "derived", fieldKind: "primitive.Long",
    desc: { ko: "실제 체결 가격이 시장 기준 시세에서 얼마나 벗어나는지 (100 = 1%)", en: "Effective rate divergence from oracle (bp)" },
    unit: { ko: "bp", en: "bp" } },
