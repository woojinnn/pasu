...
#
# Env knobs:
#   SCOPEBALL_DUMP_DIR  default /tmp/sourcify_dump
#   SCOPEBALL_VENV      default /tmp/parquet_venv
#
# Flags:
...
DUMP_DIR="${SCOPEBALL_DUMP_DIR:-/tmp/sourcify_dump}"
VENV="${SCOPEBALL_VENV:-/tmp/parquet_venv}"
