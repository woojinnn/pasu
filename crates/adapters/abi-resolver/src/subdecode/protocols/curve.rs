...
pub const CURVE_ROUTER_NG_ADDRESSES: &[(u64, Address)] = &[
    ...
    (
        1,
        Address::new(
            *b"\x45\x31\x2e\xa0\xeF\xf7\xE0\x9C\x83\xCB\xE2\x49\xfa\x1d\x75\x98\xc4\xC8\xcd\x4e",
        ),
    ),
    // Optimism
    (
        10,
        Address::new(
            *b"\x0D\xCD\xED\x35\x45\xD5\x65\xbA\x3B\x19\xE6\x83\x43\x13\x81\x00\x72\x45\xd9\x83",
        ),
    ),
    // BSC
    (
        56,
        Address::new(
            *b"\xA7\x2C\x85\xC2\x58\xA8\x17\x61\x43\x3B\x4e\x8d\xa6\x05\x05\xFe\x3D\xd5\x51\xCC",
        ),
    ),
    // Gnosis (xDai)
    (
    ...
    (
        252,
        Address::new(
            *b"\x56\xC5\x26\xb0\x15\x9a\x25\x88\x87\xe0\xd7\x9e\xc3\xa8\x0d\xfb\x94\x0d\x0c\xD7",
        ),
    ),
    // zkSync Era
    (
        324,
        Address::new(
            *b"\x7C\x91\x53\x90\xe1\x09\xCA\x66\x93\x4f\x1e\xB2\x85\x85\x43\x75\xD1\xB1\x27\xFA",
        ),
    ),
    // Base
    (
        8453,
        Address::new(
            *b"\x4f\x37\xA9\xd1\x77\x47\x04\x99\xA2\xdD\x08\x46\x21\x02\x0b\x02\x3f\xcf\xfc\x1F",
        ),
    ),
    // Arbitrum One
    (
        42161,
        Address::new(
            *b"\x21\x91\x71\x8C\xD3\x2d\x02\xB8\xE6\x0B\xaD\xFF\xeA\x33\xE4\xB5\xDD\x9A\x0A\x0D",
        ),
    ),
    // Avalanche
    (
    ...
    (
        196,
        Address::new(
            *b"\xBF\xab\x8e\xbc\x83\x6E\x1c\x4D\x81\x83\x77\x98\xFC\x07\x6D\x21\x9C\x9a\x18\x55",
        ),
    ),
];
...
pub const CRVUSD_CONTROLLERS: &[CrvusdControllerEntry] = &[
    ...
    CrvusdControllerEntry {
        chain_id: 1,
        controller: Address::new(
            *b"\x10\x0d\xaa\x78\xfc\x50\x9d\xb3\x9e\xf7\xd0\x4d\xe0\xc1\xab\xd2\x99\xf4\xc6\xce",
        ),
        collateral_symbol: "wstETH",
        collateral_token: Address::new(
    ...
    CrvusdControllerEntry {
        chain_id: 1,
        controller: Address::new(
            *b"\xEC\x08\x20\xEf\xaf\xC4\x1D\x89\x43\xEE\x8d\xE4\x95\xfC\x9B\xa8\x49\x5B\x15\xcf",
        ),
        collateral_symbol: "sfrxETH",
        collateral_token: Address::new(
            *b"\xac\x3E\x01\x84\x57\xB2\x22\xd9\x31\x14\x45\x84\x76\xf3\xE3\x41\x6A\xbb\xe3\x8F",
        ),
    },
    ...
    CrvusdControllerEntry {
        chain_id: 1,
        controller: Address::new(
            *b"\x4e\x59\x54\x13\x06\x91\x0a\xd6\xdc\x1d\xac\x0a\xc9\xdf\xb2\x9b\xd9\xf1\x5c\x67",
        ),
...
pub const VECRV_ADDRESS_MAINNET: Address = Address::new(
    *b"\x5f\x3b\x5D\xfE\xb7\xB2\x8C\xDb\xD7\xFA\xbA\x78\x96\x3E\xE2\x02\xa4\x94\xe2\xA2",
);
...
pub const GAUGE_CONTROLLER_ADDRESS_MAINNET: Address = Address::new(
    *b"\x2F\x50\xD5\x38\x60\x6F\xa9\xED\xD2\xB1\x1E\x24\x46\xBE\xb1\x8C\x9D\x58\x46\xbB",
);
...
pub const CRV_TOKEN_MAINNET: Address = Address::new(
...
pub const CRVUSD_TOKEN_MAINNET: Address = Address::new(
    *b"\xf9\x39\xe0\xa0\x3f\xb0\x7f\x59\xa7\x33\x14\xe7\x37\x94\xbe\x0e\x57\xac\x1b\x4e",
);
