...
use simulation_reducer::action::liquid_staking::ClaimWithdrawalAction;
...
mod tests {
    use simulation_reducer::action::liquid_staking::{ClaimWithdrawalAction, LiquidStakingAction};
