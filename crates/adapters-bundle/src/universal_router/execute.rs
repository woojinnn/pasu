...
pub fn decode(calldata: &[u8]) -> Result<Params, DecodeError> {
    ...
    if selector == crate::universal_router::execute_deadline::SELECTOR_EXECUTE_DEADLINE {
        return crate::universal_router::execute_deadline::decode(calldata);
    }
    ...
    Err(DecodeError::BadSelector {
        ...
        want: format!(
            ...
            hex::encode(crate::universal_router::execute_deadline::SELECTOR_EXECUTE_DEADLINE)
        ),
    })
}
...
impl DeclaredTransactionActionAdapter for Adapter_ {
    ...
    const FUNCTIONS: &'static [SolidityFunctionSpec] = &[
        ...
        SolidityFunctionSpec::new(
            ...
            crate::universal_router::execute_deadline::SELECTOR_EXECUTE_DEADLINE,
        ),
    ];
...
mod tests {
    ...
    fn round_trip_execute_with_deadline() {
        let calldata = crate::universal_router::execute_deadline::encode_execute_deadline(
    ...
    fn v4_exact_in_single_command_emits_aggregate_dex_action() {
        let pool_key = crate::universal_router::v4_actions::PoolKey {
        ...
        let swap_params = crate::universal_router::v4_actions::V4ExactInputSingleParams {
            poolKey: pool_key,
            zeroForOne: true,
