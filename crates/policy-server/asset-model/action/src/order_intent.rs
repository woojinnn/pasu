...
//!   **required**.
//! - [`HlOrderAction`](crate::hyperliquid_core::HlOrderAction) — the thin
...
//!   - size — perp uses [`SizeSpec`](crate::perp::SizeSpec) (a `U256`
...
impl OrderIntent for crate::hyperliquid_core::HlOrderAction {
    fn is_buy(&self) -> bool {
        self.is_buy
    }
...
mod tests {
    ...
    use crate::hyperliquid_core::HlOrderAction;
    use crate::perp::{
