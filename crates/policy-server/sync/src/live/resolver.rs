...
use policy_state::{FieldRef, PositionFieldName, PositionKind, TokenFieldName, WalletState};
...
pub fn resolve_field(
    ...
    match field_ref {
        FieldRef::TokenField {
            ...
            let key = serde_json::from_str::<policy_state::TokenKey>(token_key_json).ok()?;
